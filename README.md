...
# Hexagonal with Docker
gomake project myapp --arch hexagonal --with-docker
...
Each architecture generates appropriate directory structure and boilerplate code following best practices.
